...
<figure>
<img src="../../assets/maps/kanto_ch19.png" alt="The Kanto region map, every town and route cleared, the path running from Pallet Town all the way to the Indigo Plateau." style="width:70%; max-width:520px; display:block; margin:1em auto;">
