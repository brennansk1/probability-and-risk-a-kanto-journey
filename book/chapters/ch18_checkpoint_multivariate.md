...
<figure>
<img src="../../assets/maps/kanto_town_map.png" alt="Kanto town map with the route traced all the way to the Indigo Plateau in the far corner; all eight badges earned, the journey complete, only the championship ahead." style="width:70%; max-width:520px; display:block; margin:1em auto; image-rendering: pixelated;">
