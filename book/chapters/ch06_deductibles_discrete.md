...
<figure>
<img src="../../assets/maps/kanto_ch06.png" alt="Kanto town map with the southern coast highlighted: Fuchsia City, home of Koga's poison-type gym, the Soul Badge, and the great fenced Safari Zone, marked as the current destination after Celadon." style="width:70%; max-width:520px; display:block; margin:1em auto;">
